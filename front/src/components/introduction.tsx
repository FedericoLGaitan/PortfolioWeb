  ...
  return (
    <div className='z-20 w-full bg-darkBg/60 h-full'>
        ...
        <div className='flex flex-col justify-center max-w-md mx-auto md:mx-0'>
                ...
                <p className='hidden md:flex md:text-md  text-slate-100 text-center md:text-start'>I'm a junior web developer, mainly focused on front end, user interface, and user experience</p>
